...
<html>
    <head>
        ...
        <title>13 years guaranteed education</title>
...
<form class= "form-horizontal" method="POST" action="13years_insert.php">
     ...
     <h4 class="text-center"> 13 years of Guaranteed Education Stream </h4> 
 ...
 <td> 
  ...
  <div class="form-group">
       ...
       <div class="col-sm-1">
        ...
        <label for="school" class="col-sm-2 col-form-label">School or Private Candiate at GCE OL</label>
        <div class="col-sm-2">
...
<div class="table-responsive-sm">
  ...
  <div class="form-group">
    ...
    <p style= "color:red;">Please CHECK the information you provided are correct BEFORE click on SUBMIT button.<br> <b> A reference number will be provided after successful submission.</b></p></div>
    </div>
