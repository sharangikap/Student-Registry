...
$sql = "INSERT INTO S_Detail(Reference_no,Stream,Lumbini_Other,School_Private_Candidate,School,S_District,Name,Name_with_Initials,Gender,Birthday,NIC,Address1,Address2,City,Guardian_Name,ResidentialNo,Mobile1,Mobile2,E_mail,Distance,Transport,IndexNo,Medium,Religion,Sinhala,English,Science,Mathematics,History,Optional1,Result1,Optional2,Result2,Optional3,Result3) 
VALUES ('$referenceno','13+','$school','$school_private','$schoolname','$schooldistrict','$fname','$iname','$gender','$birthday','$nic','$address1','$address2','$city','$gname','$residential','$mobile1','$mobile2','$email','$distance','$transport','$indexno','$medium','$religion','$sinhala','$english','$science','$maths','$history','$op1','$optional1','$op2','$optional2','$op3','$optional3')";
